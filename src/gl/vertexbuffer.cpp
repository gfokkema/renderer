...
template void gl::VertexBuffer::load<float>(std::vector<float>, GLenum);
template void gl::VertexBuffer::load<unsigned>(std::vector<unsigned>, GLenum);
...
template<typename T>
void
gl::VertexBuffer::load(std::vector<T> data, GLenum usage)
{
